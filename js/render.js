...
(function (M) {
  ...
  var ICONS = {
    ...
    /* Пятиконечная звезда, симметричная относительно x=7.5 (левая и правая
       половины — зеркальные пары строк). Старая версия сужалась к талии
       сразу после плеч и снизу резко расходилась на два узких столбика —
       на 16x16 это читалось как человечек с ножками, а не как звезда.
       Тут нижние лучи расширяются от талии плавно и сами сужаются к
       кончику (5px -> 3px), а не торчат прямыми стойками. */
    star: [
      ["i",7,2,2,1],["i",6,3,4,1],["i",5,4,6,1],["i",3,5,10,1],["i",2,6,12,1],
      ["i",3,7,10,1],["i",4,8,8,1],["i",5,9,6,1],["i",3,10,10,1],
      ["i",2,11,5,1],["i",9,11,5,1],["i",3,12,3,1],["i",10,12,3,1],
      ["g",7,3,2,1],["g",6,4,4,1],["g",5,5,6,1],["g",3,6,10,1],["g",4,7,8,1],
      ["g",5,8,6,1],["g",6,9,4,1],["g",5,10,2,1],["g",9,10,2,1],
      ["g",3,11,3,1],["g",10,11,3,1]
    ],
    envelope: [
